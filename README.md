...
python3 main.py --config_file /home/stu2/HLLM/code/overall/LLM_deepspeed.yaml HLLM/HLLM.yaml --loss nce --epochs 5 --dataset amazon_books --train_batch_size 16 --MAX_TEXT_LENGTH 256 --MAX_ITEM_LIST_LENGTH 10 --checkpoint_dir checkpoint_dir --optim_args.learning_rate 1e-4 --item_pretrain_dir baichuan-inc/Baichuan2-7B-Base --user_pretrain_dir baichuan-inc/Baichuan2-7B-Base --text_path /home/stu2/HLLM/information --text_keys ['title', 'description'] 
```
指定 ZeRO (Zero Redundancy Optimizer) 优化器的阶段（stage）
...
python3 main.py --config_file /home/stu2/HLLM/code/overall/LLM_deepspeed.yaml HLLM/HLLM.yaml --loss nce --epochs 5 --dataset amazon_books --train_batch_size 16 --MAX_TEXT_LENGTH 256 --MAX_ITEM_LIST_LENGTH 10 --checkpoint_dir checkpoint_dir --optim_args.learning_rate 1e-4 --item_pretrain_dir 'baichuan-inc/Baichuan2-7B-Base' --user_pretrain_dir 'baichuan-inc/Baichuan2-7B-Base' --text_path /home/stu2/HLLM/information --text_keys '[\"title\", \"description\"]' --val_only True 
